...
const changePassword4ArchivesRouter = require('./routes/changePassword4Archives');
const changePassword4MediaRouter = require('./routes/changePassword4Media');
...
app.use('/changePassword4Archives', changePassword4ArchivesRouter);
app.use('/changePassword4Media', changePassword4MediaRouter);
